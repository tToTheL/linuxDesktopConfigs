...
themename     = "/muted-dream-tree-tory"
...
theme.bg_minimize   = "#22231F" --"#000000"

--theme.tasklist_disable_icon = true

theme.fg_normal     = "#CBB3DF" --"#DFDFB3"
theme.fg_focus      = "#716775" --"#6F7567"
theme.fg_urgent     = "#000000"
theme.fg_minimize   = "#FE66C4"
